...
export const FeatureSection: React.FC = () => {
  ...
  return (
    <section id="workflow" className="relative w-full bg-white rounded-t-[40px] sm:rounded-t-[48px] md:rounded-t-[60px] pt-14 pb-20 px-6 sm:px-8 lg:px-16 shadow-[0_-20px_50px_rgba(0,0,0,0.15)] z-20 overflow-hidden">
      {/* Background Decorative Accent */}
      <div className="absolute top-0 right-0 w-96 h-96 bg-blue-50/60 rounded-full blur-3xl -z-10 pointer-events-none" />
      <div className="absolute bottom-0 left-0 w-96 h-96 bg-[#A1FF00]/10 rounded-full blur-3xl -z-10 pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center max-w-2xl mx-auto mb-14">
          <motion.div
            ...
            viewport={{ once: true }}
            className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-slate-900 text-[#A1FF00] font-mono text-xs font-bold uppercase tracking-wider mb-4 shadow-sm"
          >
            <Zap className="w-3.5 h-3.5 fill-[#A1FF00]" />
          ...
          <motion.h2
            ...
            className="text-3xl sm:text-4xl md:text-5xl font-black text-slate-950 tracking-tight leading-tight uppercase font-mono"
          >
          ...
          <motion.p
            ...
            className="mt-3 text-slate-600 text-sm sm:text-base font-medium"
          >
          ...
          {steps.map((item, index) => {
            ...
            return (
              <motion.div
                ...
                whileHover={{ y: -6 }}
                className="relative bg-[#F4F6F9] hover:bg-slate-900 group rounded-3xl p-6 sm:p-7 border border-slate-200/80 hover:border-slate-800 transition-all duration-300 shadow-md hover:shadow-2xl flex flex-col justify-between"
              >
                <div>
                  {/* Top Header Row */}
                  <div className="flex items-center justify-between mb-5">
                    <div className="w-12 h-12 rounded-2xl bg-[#0B38E6] group-hover:bg-[#A1FF00] flex items-center justify-center text-white group-hover:text-slate-950 transition-colors shadow-md">
                      <Icon className="w-6 h-6 stroke-[2.2]" />
                    </div>
                    <span className="text-3xl font-black font-mono text-slate-300 group-hover:text-white/20 transition-colors">
                      {item.step}
                    </span>
                  </div>

                  {/* Title & Subtitle */}
                  <h3 className="text-lg sm:text-xl font-bold text-slate-900 group-hover:text-white transition-colors mb-2 tracking-tight">
                    {item.title}
                  </h3>
                  <p className="text-xs sm:text-sm text-slate-600 group-hover:text-slate-300 transition-colors leading-relaxed mb-6 font-medium">
                    {item.subtitle}
                  </p>
                </div>

                {/* Mini Preview Badge */}
                <div className="mt-auto bg-white group-hover:bg-slate-800 p-4 rounded-2xl border border-slate-200 group-hover:border-slate-700 transition-colors shadow-sm">
                  ...
                  <p className="text-[11px] text-slate-500 group-hover:text-slate-400 transition-colors mt-0.5 font-mono">
                    {item.badgeDetails}
                  </p>
        ...
        <motion.div
          ...
          className="mt-14 pt-8 border-t border-slate-200/80 flex flex-wrap items-center justify-between gap-4 text-xs font-semibold text-slate-500"
        >
          <div className="flex items-center gap-2">
            <ShieldCheck className="w-4 h-4 text-[#0B38E6]" />
