...
export const Footer: React.FC = () => {
  return (
    <footer className="bg-[#071C70] text-white pt-20 pb-10 px-6 sm:px-8 lg:px-12 border-t border-white/10 relative z-30 font-sans">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 lg:gap-8 pb-16 border-b border-white/10">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="flex items-center gap-2">
              <span className="text-3xl font-black font-mono tracking-tight text-white flex items-baseline">
                SkillLoom
                <div className="w-2.5 h-2.5 rounded-full bg-[#A1FF00] ml-1"></div>
              </span>
            </div>
          ...
          <div>
            <h4 className="font-bold text-white uppercase text-xs tracking-wider font-mono mb-6 text-[#A1FF00]">
              Platform
            </h4>
            <ul className="space-y-4 text-sm text-blue-200/80">
              ...
              <li><a href="#" className="hover:text-white hover:translate-x-1 inline-block transition-transform">Cari Proyek</a></li>
              <li><a href="#" className="hover:text-white hover:translate-x-1 inline-block transition-transform">Untuk UMKM</a></li>
              <li><a href="#" className="hover:text-white hover:translate-x-1 inline-block transition-transform">Untuk Sekolah</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-blue-200/80">
              ...
              <li><a href="#" className="hover:text-white hover:translate-x-1 inline-block transition-transform">Pusat Bantuan</a></li>
            </ul>
          </div>
        </div>
